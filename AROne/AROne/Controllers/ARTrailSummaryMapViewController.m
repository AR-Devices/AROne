...
- (void)viewDidLoad
{
  ...
  self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, (self.view.bounds.size.width* image.size.width/image.size.height+300), self.view.bounds.size.height)];
