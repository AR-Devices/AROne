...
- (void)setThemeWithStyle:(ARSummaryCellStyle) style andValue:(NSString *)value
{
  //ccz:  create cellView
...
+ (ARSummaryCell *)cellWithStyle:(ARSummaryCellStyle)styles andValue:(NSString *)value
{
  ARSummaryCell *cell = [[ARSummaryCell alloc]init];
