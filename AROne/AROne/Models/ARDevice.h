...
@protocol  ARDeviceDelegate <NSObject>
@optional
- (void) deviceReady;
...
@interface ARDevice : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate>

@property (nonatomic) float batteryLevel;

@property (nonatomic, weak) id <ARDeviceDelegate> delegate;
...
- (void) readARDeviceInformation;
- (void) writeARDeviceInformation;
- (void) setTime;
/*!
 *  @method controlSetup:
 *
