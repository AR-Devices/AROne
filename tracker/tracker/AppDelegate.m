...
//  tracker
//
//  Created by Chenchen Zheng on 12/16/14.
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ar-devices.tracker" in the application's documents directory.
...
- (NSManagedObjectContext *)managedObjectContext {
    ...
    NSDictionary *userInfo = _managedObjectContext ? @{ DatabaseAvailabilityContext : self.managedObjectContext } : nil;
